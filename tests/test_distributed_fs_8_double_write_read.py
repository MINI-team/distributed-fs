...
def execute_client_command():
    ...
    client_commands = (
        ...
        "./client write ala 172.17.0.1",
        "./client read ala 172.17.0.1",
...
def test_client_output(setup_docker_environment):
    ...
    client_file = Path("../build/client/ala")
    output_file = Path("../build/client/ala_output.txt")
    assert compare_md5(client_file, output_file), "MD5 checksum mismatch for ala"
